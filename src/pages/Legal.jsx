  ...
  return (
    ...
    >
      <Container className="Legal">
        <p>
          <span className="Legal__paragraph">1. DATOS IDENTIFICATIVOS</span>
        </p>
        <p>
          ...
          siguientes datos: la empresa titular de dominio web es LA MANGA MAR
          MENOR CHARTER (en adelante LMMMC), con domicilio a estos efectos en
          Madrid número de C.I.F.: CIF inscrita en el Registro Mercantil de
          Madrid. Correo electrónico de contacto:
          info@lamangamarmenorcharter.com del sitio web.
        </p>
        <p>
          <span className="Legal__paragraph">2. USUARIOS</span>
        </p>
        <p>
          <span className="Legal__paragraph">
            El acceso y/o uso de este portal de LMMMC atribuye la condición de
        ...
        <p>
          www.lamangamarmenorcharter.com proporciona el acceso a multitud de
          informaciones, servicios, programas o datos (en adelante, «los
          contenidos») en Internet pertenecientes a LMMMC o a sus licenciantes a
          los que el USUARIO pueda tener acceso. El USUARIO asume la
          ...
          contenidos y servicios (como por ejemplo servicios de chat, foros de
          discusión o grupos de noticias) que Nombre de la empresa creadora del
          sitio web ofrece a través de su portal y con carácter enunciativo pero
          no limitativo, a no emplearlos para (i) incurrir en actividades
          ilícitas, ilegales o contrarias a la buena fe y al orden público; (ii)
          ...
          resultaran adecuados para su publicación. En cualquier caso, LMMMC no
        ...
        <p>
          <span className="Legal__paragraph">&nbsp;</span>
          <span className="Legal__paragraph">4. PROTECCIÓN DE DATOS</span>
        </p>
        <p>
          LMMMC cumple con las directrices de la Ley Orgánica 15/1999 de 13 de
          ...
          desarrollo de la Ley Orgánica y demás normativa vigente en cada
          momento, y vela por garantizar un correcto uso y tratamiento de los
          datos personales del usuario. Para ello, junto a cada formulario de
          recabo de datos de carácter personal, en los servicios que el usuario
          pueda solicitar a acippia@acippia.org, hará saber al usuario de la
          existencia y aceptación de las condiciones particulares del
          tratamiento de sus datos en cada caso, informándole de la
          ...
          comunicaciones de datos a terceros en su caso. Asimismo, LMMMC informa
          que da cumplimiento a la Ley 34/2002 de 11 de julio, de Servicios de
          la Sociedad de la Información y el Comercio Electrónico y le
          solicitará su consentimiento al tratamiento de su correo electrónico
        ...
        <p>
          LMMMC por sí o como cesionaria, es titular de todos los derechos de
          propiedad intelectual e industrial desu página web, así como de los
          ...
          acceso y uso, etc.), titularidad de LMMMC o bien de sus
          licenciantes.&nbsp;
          <span className="Legal__paragraph">
            ...
            cualquier medio técnico, sin la autorización de LMMMC. El USUARIO se
            compromete a respetar los derechos de Propiedad Intelectual e
            Industrial titularidad de LMMMC. Podrá visualizar los elementos del
            portal e incluso imprimirlos, copiarlos y almacenarlos en el disco
            ...
            que estuviera instalado en el las páginas de LMMMC.
          </span>
        </p>
        <p>
          <span className="Legal__paragraph">
        ...
        <p>
          LMMMC no se hace responsable, en ningún caso, de los daños y
        ...
        <p>
          LMMMC se reserva el derecho de efectuar sin previo aviso las
        ...
        <p>8. ENLACES</p>
        <p>
          En el caso de que en www.lamangamarmenorcharter.com se dispusiesen
          enlaces o hipervínculos hacía otros sitios de Internet, LMMMC no
          ejercerá ningún tipo de control sobre dichos sitios y contenidos. En
          ningún caso LMMMC asumirá responsabilidad alguna por los contenidos de
        ...
        <p>
          LMMMC se reserva el derecho a denegar o retirar el acceso a portal y/o
          los servicios ofrecidos sin necesidad de preaviso, a instancia propia
          o de un tercero, a aquellos usuarios que incumplan las presentes
          Condiciones Generales de Uso.
        </p>
        <p>10.GENERALIDADES</p>
        <p>
          LMMMC perseguirá el incumplimiento de las presentes condiciones así
        ...
        <p>
          LMMMC podrá modificar en cualquier momento las condiciones aquí
        ...
        <p>
          La relación entre LMMMC y el USUARIO se regirá por la normativa
        ...
        <p>
          <span className="Legal__paragraph">¿QUÉ SON LAS COOKIES?</span>
        </p>
        <p>
        ...
        <p>
          <span className="Legal__paragraph">DESACTIVAR LAS COOKIES.</span>
        </p>
        <p>
        ...
        <p>
          <span className="Legal__paragraph">COOKIES DE TERCEROS.</span>
        </p>
        <p>
